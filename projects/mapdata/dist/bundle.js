...
/***/ function(module, exports, __webpack_require__) {
	...
	function getGeography() {
	    return new es6_promise_1.Promise(function (resolve, reject) {
	        d3.json("https://assets.zackward.net/world-110m.v1.json", function (error, world) {
	            if (error)
	                reject(error);
	            resolve(world);
	        });
	...
	function getFeatures() {
	    return new es6_promise_1.Promise(function (resolve, reject) {
	        d3.json("https://assets.zackward.net/meteorite-strike-data.json", function (error, data) {
	            if (error)
	                reject(error);
	            resolve(data);
	        });
