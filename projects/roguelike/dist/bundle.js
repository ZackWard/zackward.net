...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Roguelike = function (props) {
	    ...
	    return (React.createElement("div", {className: "roguelike"}, React.createElement("div", {className: "container"}, screen), React.createElement("footer", {className: "footer"}, React.createElement("div", {className: "container text-center"}, React.createElement("p", {className: "text-muted"}, React.createElement("small", null, "Built with React, Redux, and Love by ", React.createElement("a", {href: "http://www.zackward.net"}, "Zack Ward"), "." + ' ' + "Modified ", React.createElement("a", {href: "http://opengameart.org/content/dawnlike-16x16-universal-rogue-like-tileset-v181"}, "DawnLike"), " tileset used under ", React.createElement("a", {href: "https://creativecommons.org/licenses/by-sa/3.0/"}, "CC BY-SA 3.0"), " license." + ' ' + "Palette designed by DawnBringer." + ' ' + "Source code on ", React.createElement("i", {className: "fa fa-github", "aria-hidden": "true"}), React.createElement("a", {href: "https://github.com/ZackWard/zackward.github.io/tree/master/projects/roguelike"}, "GitHub.")))))));
	};
